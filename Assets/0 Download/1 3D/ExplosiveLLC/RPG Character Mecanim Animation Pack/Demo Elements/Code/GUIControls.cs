    ...
    public class GUIControls : MonoBehaviour
    {
		...
		private void Attacks()
		{
			...
			if (rpgCharacterController.hasLeftWeapon
				|| (rpgCharacterController.leftWeapon == Lookups.Weapon.Unarmed && rpgCharacterController.rightWeapon == Lookups.Weapon.Unarmed)) {
			...
			if (rpgCharacterController.hasRightWeapon
				|| (rpgCharacterController.rightWeapon == Lookups.Weapon.Unarmed && rpgCharacterController.leftWeapon == Lookups.Weapon.Unarmed)) {
			...
			if (rpgCharacterController.hasDualWeapons) {
				...
				if (rpgCharacterController.rightWeapon != Lookups.Weapon.RightItem && rpgCharacterController.leftWeapon != Lookups.Weapon.LeftItem
					&& rpgCharacterController.leftWeapon != Lookups.Weapon.Shield) {
			...
			if ((rpgCharacterController.leftWeapon == Lookups.Weapon.LeftSword || rpgCharacterController.leftWeapon == Lookups.Weapon.LeftMace)
				&& (rpgCharacterController.rightWeapon == Lookups.Weapon.RightSword || rpgCharacterController.rightWeapon == Lookups.Weapon.RightMace)) {
				if (GUI.Button(new Rect(335, 85, 100, 30), "Special Attack1"))
        ...
        private void Casting()
        {
            ...
            var leftUnarmed = rpgCharacterController.leftWeapon == Lookups.Weapon.Unarmed;
            var rightUnarmed = rpgCharacterController.rightWeapon == Lookups.Weapon.Unarmed;
            var wieldStaff = rpgCharacterController.rightWeapon == Lookups.Weapon.TwoHandStaff;
		...
		private void WeaponSwitching()
		{
			...
			if (rpgCharacterController.rightWeapon != Lookups.Weapon.Unarmed
				...
				if (GUI.Button(new Rect(1115, 280, 100, 30), "Unarmed")) {
					...
					context.rightWeapon = Lookups.Weapon.Unarmed;
				}
			}
			...
			foreach (var weapon in WeaponGroupings.TwoHandedWeapons) {
				if (rpgCharacterController.rightWeapon != weapon) {
					...
					if (GUI.Button(new Rect(1115, offset, 100, 30), label)) {
						...
						context.type = "Switch";
						context.side = "None";
						context.leftWeapon = Lookups.Weapon.Relax;
			...
			foreach (var pair in WeaponGroupings.LeftRightWeaponPairs) {
				...
				if (rpgCharacterController.leftWeapon != pair.Item1) {
					...
					if (GUI.Button(new Rect(1065, offset, 100, 30), pair.Item1.ToString())) {
						...
						context.rightWeapon = Lookups.Weapon.Relax;
					}
				}
				// Right weapons.
