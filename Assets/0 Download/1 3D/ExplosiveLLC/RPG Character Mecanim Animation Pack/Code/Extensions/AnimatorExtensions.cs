...
namespace RPGCharacterAnims.Extensions
{
    ...
    public static class AnimatorExtensions
    {
		...
		public static void SetWeapons(this Animator animator, AnimatorWeapon animatorWeapon, int weaponSwitch, Lookups.Weapon leftWeapon, Lookups.Weapon rightWeapon, Side weaponSide)
		{
			...
			if (leftWeapon != Lookups.Weapon.Relax) { animator.SetInteger(AnimationParameters.LeftWeapon, ( int )leftWeapon); }
			if (rightWeapon != Lookups.Weapon.Relax) { animator.SetInteger(AnimationParameters.RightWeapon, ( int )rightWeapon); }
