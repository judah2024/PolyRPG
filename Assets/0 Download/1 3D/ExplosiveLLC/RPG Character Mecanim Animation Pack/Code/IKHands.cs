    ...
    public class IKHands : MonoBehaviour
    {
		...
		private void GetCurrentWeaponAttachPoint(Lookups.Weapon weapon)
		{
			...
			switch (weaponType) {
				...
				case Lookups.Weapon.TwoHandSpear: blendToTransform = rpgCharacterWeaponController.twoHandSpear.transform.GetChild(0).transform; break;
				case Lookups.Weapon.TwoHandAxe: blendToTransform = rpgCharacterWeaponController.twoHandAxe.transform.GetChild(0).transform; break;
				case Lookups.Weapon.TwoHandCrossbow: blendToTransform = rpgCharacterWeaponController.twoHandCrossbow.transform.GetChild(0).transform; break;
				case Lookups.Weapon.Rifle: blendToTransform = rpgCharacterWeaponController.rifle.transform.GetChild(0).transform; break;
			}
		}
    }
}