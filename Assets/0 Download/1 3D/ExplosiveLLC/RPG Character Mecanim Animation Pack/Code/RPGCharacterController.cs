    ...
    public class RPGCharacterController : MonoBehaviour
    {
		...
		public bool isRelaxed
		{
			get {
				...
				return rightWeapon == Lookups.Weapon.Relax && leftWeapon == Lookups.Weapon.Relax;
			}
		}
		...
		/// </summary>
		public bool hasShield => leftWeapon == Lookups.Weapon.Shield;
        ...
        public void Attack(int attackNumber, Side attackSide, Lookups.Weapon leftWeapon, Lookups.Weapon rightWeapon, float duration)
        {
			...
			if (rightWeapon == Lookups.Weapon.Rifle) {
        ...
        public void EndBlock()
        {
            ...
            Unlock(true, true);
			if (hasAimedWeapon) { SetIKOn(( Lookups.Weapon )animator.GetInteger(AnimationParameters.Weapon)); }
		}
		...
		public void Activate()
		{
			...
			SetIKPause(rightWeapon == Lookups.Weapon.TwoHandAxe ? 1.4f : 1f);
		}
