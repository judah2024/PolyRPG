...
namespace BookmarkEverything
{
	public class BookmarkEverythingEditor : EditorWindow
    {
        ...
        private const string CATEGORY_SO = "Scriptable";
        ...
        [MenuItem("MGH/Bookmark Everything %h", false, priority:20)]
...
#region MAIN HEADER DRAWERS
        ...
        private void DrawHeader()
        {
            ...
            _tabIndex = GUILayout.Toolbar(_tabIndex, _headerContents.ToArray(), _toolbarButtonStyle);
